...
browser = webdriver.Chrome("C://Users/ethan/OneDrive/Desktop/WH Jr. Projects/Python Programming/C 127/chromedriver.exe")
...
def scrape():
    for i in range(1, 454):
        while True:
            ...
            current_page_num = int(soup.find_all("input", attrs = {"class", "page_number"})[0].get("value"))
...
def scrape_more_data(hyperlink):
    try:
        ...
        temp_list = []
        for tr_tag in soup.find_all("tr", attrs = {"class": "pack_row"}):
